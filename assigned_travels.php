...
$query ="SELECT * FROM travel_request where assigned_to='".$_SESSION['userid']."' and status='consultant manager approval'";
									...
									<tbody>
										<?php foreach($result as $row) : ?>
											<tr>
												...
												<td><a href="approve_travel.php?id=<?php echo  $row['travel_id']; ?>" class="btn btn-success"><i class="fa fa-check"> Approve</i></a> &nbsp; &nbsp; <a href="reject_travel.php?id=<?php echo  $row['travel_id']; ?>" class="btn btn-danger"><i class="fa fa-close"> Reject</i></a>&nbsp;&nbsp;<a href="view_travel.php?id=<?php echo $row['travel_id'] ?>" class="btn btn-primary"><i class="fa fa-search"></i> View</a></td>
